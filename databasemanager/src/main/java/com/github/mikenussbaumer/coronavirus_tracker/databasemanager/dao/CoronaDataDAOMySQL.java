 ...
 */
public class CoronaDataDAOMySQL implements CoronaDataDAO {

    MySQLManager mySQLManager;

    public CoronaDataDAOMySQL ( MySQLManager mySQLManager ) {
    ...
    public boolean saveCoronaData ( List < CoronaData > coronaData ) {
        ...
        try {
            PreparedStatement preparedStatement = mySQLManager.getConnection( ).prepareStatement( query );
